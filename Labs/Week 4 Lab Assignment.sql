...
-- 1. Select Player first name, last name, height and position.  Rank all players by height, ties should have the same --
-- rank with a gap after the tie.  Reset the rankings for each position.  We are only interested in players with assigned positions --
