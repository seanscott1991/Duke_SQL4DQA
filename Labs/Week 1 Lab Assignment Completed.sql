...
-- 8. Using the part table, what are the top 5 least expensive parts that have a part type that is not considered small? --
SELECT
	p_name
    , p_retailprice
FROM
...
-- 10. In the part table, price per pound is considered to be the retail price divided by the part size.  Return price per pound for each manufacturer.  --
SELECT
	p_mfgr,
