...
-- 1. List of members who have made a charge of category 10 (Repeat of demo 4.2.1) --
SELECT
	CONCAT(firstname, ' ', lastname) as "Member Full Name"
FROM
	member m
...
-- 3. Join in aggregated information (as opposed to grouping by several columns) --
SELECT
	m.*
...
-- 1. Recode demo 4.3.3 using CTEs --
WITH T1 AS
	(
	SELECT
		COUNT(*)
...
-- 2. Recode demo 4.5.3 using CTEs --
...
SELECT
	...
	SUM(category_no = 7) AS CAT_7_SHRTHND
FROM
	charge
GROUP BY
	member_no
