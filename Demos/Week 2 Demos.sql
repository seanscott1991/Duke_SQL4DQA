...
-- 2. Select all columns in the charge table and join in the statement date column from the statement table --
SELECT
	charge.*
...
-- 3. Select all columns in the charge table and join in the statement date column from the statement table using a left join --
SELECT
	charge.*
    , statement.statement_dt
FROM
...
-- 1. Select all columns in the charge table and join in the statement date column from the statement table using a right join --
SELECT
	charge.*
    , statement.*
FROM
...
-- 1. Select all columns in the charge table and join in the statement date column from the statement table using a left join and table aliases --
SELECT
	c.*
    , s.statement_dt
FROM
