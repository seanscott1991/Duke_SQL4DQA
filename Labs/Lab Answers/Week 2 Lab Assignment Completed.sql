...
-- 3.  Write a query that returns all rows from the lineitem table with shipmode of RAIL and include the shipping priority column --
--     from the orders table and the name column from the customer table --
SELECT
	l.*
	, o.o_orderpriority
    , c.c_name
